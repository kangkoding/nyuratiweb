                    ...
                    <div class="modal-content bg-white border-0">
                        ...
                        <div class="modal-body" style="padding: 2rem; padding-top: 0; padding-bottom: 0">
                            <ul class="navbar-nav responsive me-auto mt-2 mt-lg-0">
                                <li class="nav-item">
                                    <a class="nav-link fs-3 text-success" href="#">NYURATI</a>
                                </li>
                        ...
                        <div class="modal-footer border-0 gap-3" style="padding: 2rem; padding-top: 0.75rem">
                            ...
                            <button class="btn btn-fill text-white">Buat Surat!</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mx-auto d-flex flex-lg-row flex-column hero">
                ...
                <div class="left-column d-flex flex-lg-grow-1 flex-column align-items-lg-start text-lg-start align-items-center text-center">
                    <h1 class="title-text-big">
                        Buat<br class="d-lg-block d-none" />
                        Suratmu Lebih Cepat !
                    </h1>
                    <div class="d-flex flex-sm-row flex-column align-items-center mx-lg-0 mx-auto justify-content-center gap-3">
                        <div class="section-underline" style="background-color: red; width: 200px; height: 200px;"></div>
                    </div>
                </div>
                <!-- Right Column -->
                <div class="right-column text-center d-flex justify-content-lg-end justify-content-center pe-0">
                    <img id="img-fluid" class="h-auto mw-100" src="{{ base_url('assets/img/section-1-illustration.png') }}" alt="" />
                </div>
            </div>
        </div>
    </div>
